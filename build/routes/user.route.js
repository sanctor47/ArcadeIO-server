...
router.post('', userController.newUser); //route to get a single user by their user id

router.get('/id/:_id', userController.getUser); //route to update a single user by their user id
...
router.post('/login', userController.login); // router.get('/register')
