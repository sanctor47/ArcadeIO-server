...
var getAllScores = /*#__PURE__*/function () {
  ...
  return function getAllScores(_x, _x2, _x3) {
...
var getScore = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return ScoreService.getScore(req.params._id);
  ...
  return function getScore(_x4, _x5, _x6) {
...
var newScore = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return ScoreService.newScore(req.body);
  ...
  return function newScore(_x7, _x8, _x9) {
...
var updateScore = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            _context4.next = 3;
            return ScoreService.updateScore(req.params._id, req.body);
  ...
  return function updateScore(_x10, _x11, _x12) {
...
var deleteScore = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            _context5.next = 3;
            return ScoreService.deleteScore(req.params._id);
  ...
  return function deleteScore(_x13, _x14, _x15) {
