...
var GameService = _interopRequireWildcard(require("../services/game.service"));
...
var getAllGames = /*#__PURE__*/function () {
  ...
  return function getAllGames(_x, _x2, _x3) {
...
var getGame = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return GameService.getGame(req.params._id);
  ...
  return function getGame(_x4, _x5, _x6) {
...
var newGame = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return GameService.newGame(req.body);
  ...
  return function newGame(_x7, _x8, _x9) {
...
var updateGame = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            _context4.next = 3;
            return GameService.updateGame(req.params._id, req.body);
  ...
  return function updateGame(_x10, _x11, _x12) {
...
var deleteGame = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            _context5.next = 3;
            return GameService.deleteGame(req.params._id);
  ...
  return function deleteGame(_x13, _x14, _x15) {
...
var startGame = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _context6.prev = 0;
            _context6.next = 3;
            return GameService.startGame(req.body);
  ...
  return function startGame(_x16, _x17, _x18) {
