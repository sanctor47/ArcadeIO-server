...
var PrizeService = _interopRequireWildcard(require("../services/prize.service"));
...
var getAllPrizes = /*#__PURE__*/function () {
  ...
  return function getAllPrizes(_x, _x2, _x3) {
...
var getPrize = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return PrizeService.getPrize(req.params._id);
  ...
  return function getPrize(_x4, _x5, _x6) {
...
var newPrize = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return PrizeService.newPrize(req.body);
  ...
  return function newPrize(_x7, _x8, _x9) {
...
var updatePrize = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            _context4.next = 3;
            return PrizeService.updatePrize(req.params._id, req.body);
  ...
  return function updatePrize(_x10, _x11, _x12) {
...
var deletePrize = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            _context5.next = 3;
            return PrizeService.deletePrize(req.params._id);
  ...
  return function deletePrize(_x13, _x14, _x15) {
